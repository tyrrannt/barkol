(function (C, U) {
    ...
    var palettes = {
        honeybee: {
            "popup": {"background": '#07dabf', "text": "#ffffff"},
            "button": {"background": '#6156ce', "text": "#ffffff"}
        },
        blurple: {
            "popup": {"background": '#9960ea', "text": "#ffffff"},
            "button": {"background": '#00d1c1', "text": "#ffffff"}
        },
        mono: {
            "popup": {"background": "#24ccda", "text": "#ffffff"},
            "button": {"background": "transparent", "border": "#fff", "text": "#fff"}
        },
        nuclear: {
            "popup": {"background": "#3b3f5c", "text": "#ffffff"},
            "button": {"background": "#888ea8", "text": "#ffdddd"}
        },
