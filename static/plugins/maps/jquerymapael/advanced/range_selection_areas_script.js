$(function () {
    ...
    slider = noUiSlider.create($(".slider1")[0], {
        start: [0, 3000000],
        step: 100000,
        connect: true,
    ...
    slider.on('set', function (values) {
        ...
        $(".mapcontainer11").trigger("showElementsInRange", [opt]);
        $(".values1").text("Show area with a population between " + parseInt(values[0]) + " and " + parseInt(values[1]) + " inhabitants");
    });
...
$(function () {
    ...
    slider = noUiSlider.create($(".slider2")[0], {
        start: [0, 300000],
        step: 10000,
        connect: true,
        orientation: 'horizontal',
    ...
    slider.on('set', function (values) {
        ...
        $(".mapcontainer12").trigger("showElementsInRange", [opt]);
        $(".values2").text("Show cities with a population between " + parseInt(values[0]) + " and " + parseInt(values[1]) + " inhabitants");
    });
