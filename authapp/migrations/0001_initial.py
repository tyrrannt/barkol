            ...
            fields=[
                ...
                ('type_users', models.CharField(
                    choices=[('natural_person', 'физическое лицо'), ('staff_member', 'штатный сотрудник'),
                             ('freelancer', 'внештатный сотрудник')], max_length=40, verbose_name='тип пользователя')),
                ('address',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='authapp.Address')),
